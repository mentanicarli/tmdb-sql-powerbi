# Аналитика кинорынка TMDB — SQL + Power BI

Исследование кинорынка на основе датасета TMDB (78 000+ фильмов): нормализация данных в реляционную БД, SQL-анализ с оконными функциями, интерактивный дашборд в Power BI.
...
├── sql/
│   └── genre_analysis.sql    # SQL-запросы с оконными функциями
├── notebooks/
│   └── prepare_database.ipynb # Python: CSV → SQLite БД
├── dashboard/
...
Мишанов Максим — студент группы ТЦБМ23-3, Финансовый университет при Правительстве РФ
